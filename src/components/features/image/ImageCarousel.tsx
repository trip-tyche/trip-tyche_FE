...
const ImageCarousel = ({ images, onStateChange }: ImageCarouselProps) => {
    ...
    return (
        ...
        <Slider {...settings} ref={sliderRef} css={carouselStyle}>
...
const SlideItem = React.memo(({ image, isCurrent, isZoomed }: SlideItemProps) => (
