...
//     // const [images, setimages] = useState<UnlocatedMediaFiles[]>();
...
//     const [isSelectionMode, setIsSelectionMode] = useState(false);
//     const [unlocatedImages, setUnlocatedImages] = useState<UnlocatedMediaFiles[]>([]);
//     const [selectedImages, setSelectedImages] = useState<MediaFileMetaData[]>([]);
//     const [selectedLocation, setSelectedLocation] = useState<Location | null>(null);
//     const [selectedDate, setSelectedDate] = useState<Date | null>(null);
...
//             try {
//                 const images = await mediaAPI.getUnlcoatedImages(tripKey!);
//                 setUnlocatedImages(images || []);
//             } catch (error) {
