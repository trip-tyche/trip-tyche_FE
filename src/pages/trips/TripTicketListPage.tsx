...
//     const { data, isLoading } = useTripTicketList();
...
//         const inValidTripList = data.trips.filter((trip: TripModel) => trip.tripTitle === 'N/A');
//         const validTripList = data.trips.filter((trip: TripModel) => trip.tripTitle !== 'N/A').reverse();

//         if (inValidTripList.length > 3) {
//             deleteInValidTrips(data.trips);
//         }
